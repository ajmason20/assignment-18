...
function controllerRouter() {
  ...
  if (currentRoute === 'concerts') {
    (function () {
      ...
      var createConcertPageTemplate = function createConcertPageTemplate(dataArray, title) {
        var bigHTMLStr = '';
  ...
  if (currentRoute === 'flight') {
    (function () {
      var createArrivalPageTemplate = function createArrivalPageTemplate(dataArray, title) {
      ...
      var createDeparturePageTemplate = function createDeparturePageTemplate(dataArray, title) {
        console.log("ehhhy");
  ...
  if (currentRoute === 'rides/samferda-drivers/') {
    var _ret3 = function () {
      var createRidesPageTemplate = function createRidesPageTemplate(dataArray, title) {
